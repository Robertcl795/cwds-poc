import { createSelectController, type SelectOption } from '@covalent-poc/headless-core';
...
export const createCompositeSelect = (config: PrimitiveSelectOptions): HTMLSelectElement => {
